...
public interface RecordMapper {
    ...
    @Insert("INSERT INTO tb_r_done (r_done_state_id, r_done_start_date, r_done_end_date, r_done_star, r_done_review) " +
            "VALUES (#{stateId}, #{startDate}, #{endDate}, #{rating}, #{comment})")
    int insertDone(CreateRecordReqDTO dto);

    // tb_r_doing ---------------------------------------------------------------------------------
    // 250204 박연화 Doing 테이블 insert
    @Insert("INSERT INTO tb_r_doing (r_doing_state_id, r_doing_start_date, r_doing_progress) " +
