...
public interface RecordMapper {
    ...
    int selectStateByBookIdAndStateType(CreateRecordReqDTO dto);
    ...
    RecordStateDTO selectStateByBookIdAndUserId(CreateRecordReqDTO dto);
    ...
    RecordDTO selectDoneByStateId(CreateRecordReqDTO dto);
    ...
    RecordDTO selectDoingByStateId(CreateRecordReqDTO dto);
    ...
    RecordDTO selectWishByStateId(CreateRecordReqDTO dto);
    ...
    RecordDTO selectStopByStateId(CreateRecordReqDTO dto);
